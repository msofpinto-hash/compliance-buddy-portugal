...
- [ ] Calendário de auditorias: clicar no evento abre documentação (pré-visualizar/exportar)
- [ ] Plano/informação da auditoria editável pelo admin no próprio diálogo
