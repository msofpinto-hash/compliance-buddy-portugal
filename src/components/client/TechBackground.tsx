...
export const TechGridBackground = () => (
 ...
 {/* Terracotta accent */}
 <motion.div 
 className="absolute top-1/4 left-1/6 w-80 h-80 rounded-full opacity-15 dark:opacity-10"style={{
 ...
 {/* Emerald accent */}
 <motion.div 
 className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full opacity-10 dark:opacity-[0.08]"style={{
...
export const NeonBorder = ({ 
 ...
 const glowColors = {
 amber: "shadow-[0_4px_20px_hsl(38_80%_45%/0.15)] border-primary/40 hover:border-primary/60 hover:shadow-[0_8px_30px_hsl(38_80%_45%/0.25)]",
 ...
 emerald: "shadow-[0_4px_20px_hsl(152_60%_35%/0.15)] border-primary/40 hover:border-primary/60 hover:shadow-[0_8px_30px_hsl(152_60%_35%/0.25)]"
 };
