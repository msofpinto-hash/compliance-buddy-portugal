...
export const TechGridBackground = () => (
  <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-primary via-border to-orange-50/50 " />
 ...
 `,
    ...
    <motion.div
      ...
      style={{
        background:
          "radial-gradient(circle, hsl(15 50% 55% / 0.4) 0%, transparent 70%)",
      }}
    ...
    <motion.div
      ...
      style={{
        background:
          "radial-gradient(circle, hsl(152 70% 35% / 0.3) 0%, transparent 70%)",
      }}
...
export const NeonBorder = ({
  ...
  const glowColors = {
    amber:
      "shadow-[0_4px_20px_hsl(38_80%_45%/0.15)] border-primary/40 hover:border-primary/60 hover:shadow-[0_8px_30px_hsl(38_80%_45%/0.25)]",
    terracotta:
      "shadow-[0_4px_20px_hsl(15_50%_45%/0.15)] border-orange-300/40 dark:border-orange-800/40 hover:border-orange-400/60 dark:hover:border-orange-700/60 hover:shadow-[0_8px_30px_hsl(15_50%_45%/0.25)]",
    emerald:
      "shadow-[0_4px_20px_hsl(152_60%_35%/0.15)] border-primary/40 hover:border-primary/60 hover:shadow-[0_8px_30px_hsl(152_60%_35%/0.25)]",
  };

  return (
    <div
      className={`
 relative rounded-2xl border bg-white/80 backdrop-blur-xl
