...
export function IDSidebar({ currentOrg, onCloseMobile }: IDSidebarProps) {
 ...
 isActive 
 ? "bg-gradient-to-r from-primary to-primary text-white shadow-md":"text-muted-foreground hover:bg-accent hover:text-foreground dark:hover:text-white"
 )}
 >
 ...
 isActive 
 ? "bg-white/20 text-white border-0":"bg-accent text-primary border-0"
 )}>
 {item.count}
 </Badge>
 )}
