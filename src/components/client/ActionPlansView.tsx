...
const statusConfig: Record<string, { label: string; color: string; bgColor: string; icon: React.ElementType; gradient?: string }> = {
 ...
 em_curso: { label:"Em Curso", color: "text-primary", bgColor: "bg-accent border-primary", icon: AlertCircle, gradient: "from-primary to-primary"},
 concluido: { label:"Concluído", color: "text-primary", bgColor: "bg-primary border-primary", icon: CheckCircle2, gradient: "from-primary to-primary"},
...
const priorityConfig: Record<string, { label: string; color: string; bgColor: string; dotColor: string; ringColor: string }> = {
 ...
 media: { label:"Média", color: "text-primary", bgColor: "bg-accent border-primary", dotColor: "bg-gradient-to-br from-primary to-primary", ringColor: "ring-primary"},
 baixa: { label:"Baixa", color: "text-primary", bgColor: "bg-primary border-primary", dotColor: "bg-gradient-to-br from-primary to-primary", ringColor: "ring-primary"},
};
...
function ImportFromAuditDialog({ 
 ...
 ? "bg-primary/10 border-primary":"hover:bg-muted"
 }`}
 >
 ...
 <Badge variant="outline"className={finding.compliance_status ==="non_compliant"?"bg-red-100 text-red-700":"bg-accent text-primary"}>
 ...
 *,
 ...
 badge="Ações Corretivas"icon={ClipboardList}
 stats={[
 ...
 <Button variant="outline" size="sm" className="gap-2 bg-accent/50 border-border/80 hover:bg-accent ">
 ...
 <p className="text-3xl font-bold text-primary ">{stats.em_curso}</p>
 </div>
 ...
 <p className="text-3xl font-bold text-primary ">{stats.concluido}</p>
 </div>
 ...
 ? "Crie o seu primeiro plano de ação para começar a gerir as suas ações corretivas.":"Tente ajustar os filtros para encontrar o que procura."}
 </p>
 {actionPlans?.length === 0 && (
 <div className="mt-6">
 <CreateActionPlanDialog organizations={organizations} onCreated={refetch} />
