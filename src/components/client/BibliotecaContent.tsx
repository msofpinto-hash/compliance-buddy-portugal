    ...
    try {
      ...
      if (raw) {
        ...
        if (
          ...
          parsed.selectedThemeId === null
        )
          setSelectedThemeId(parsed.selectedThemeId ?? null);
        if (
          typeof parsed.selectedCategoryId === "string" ||
          parsed.selectedCategoryId === null
        )
          setSelectedCategoryId(parsed.selectedCategoryId ?? null);
        if (typeof parsed.selectedSource === "string")
          setSelectedSource(parsed.selectedSource);
        if (typeof parsed.selectedApplicability === "string")
          setSelectedApplicability(parsed.selectedApplicability);
        if (
          typeof parsed.filterStartDate === "string" ||
          parsed.filterStartDate === null
        )
          setFilterStartDate(parsed.filterStartDate ?? null);
        if (
          typeof parsed.filterEndDate === "string" ||
          parsed.filterEndDate === null
        )
          setFilterEndDate(parsed.filterEndDate ?? null);
      }
    } catch {
      // ignore
    }
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Explore e pesquise toda a legislação disponível organizada por temas e
          categorias
        </p>
      </div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            >
              <TabsList className="bg-primary/10">
                ...
                <TabsTrigger
                  value="dre"
                  className="text-xs gap-1 data-[state=active]:bg-primary/20 data-[state=active]:text-primary"
                >
          ...
          <div className="flex items-center gap-3 overflow-x-auto pb-2">
            ...
            <motion.button
              ...
              className={cn(
                ...
                !selectedThemeId
                  ? "bg-gradient-to-br from-primary/20 to-teal-500/20 border-2 border-primary/50 shadow-md"
                  : "bg-card/50 border-2 border-transparent hover:border-primary/30 hover:bg-primary/10",
              )}
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isSelected
                        ? cn(config.bgLight, config.bgDark)
                        : "bg-background",
                    )}
                  >
            ...
            {selectedCategoryId &&
              ...
              (() => {
                ...
                return category ? (
                  <Badge
                    variant="secondary"
                    className="gap-1 bg-teal-500/20 text-teal-400 border-teal-500/30"
                  >
                    <Folder className="h-3 w-3" />
                    {category.name}
                    <button
                      onClick={() => setSelectedCategoryId(null)}
                      className="ml-1 hover:bg-teal-500/30 rounded-full p-0.5"
                    >
                      <X className="h-3 w-3" />
                    </button>
                  </Badge>
