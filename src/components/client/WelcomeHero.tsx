...
export function WelcomeHero({ 
 ...
 className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-teal-500 to-cyan-600 dark:via-teal-600 dark:to-cyan-700 shadow-2xl"
 >
 {/* Decorative Elements */}
 ...
 />
 <motion.div 
 className="absolute top-1/2 right-1/4 w-40 h-40 bg-primary/20 rounded-full blur-2xl"
 animate={{ 
 x: [0, 20, 0],
 y: [0, -20, 0]
 }}
 ...
 {organizationName && (
 <motion.p 
 className="text-primary/90 text-lg"
 initial={{ opacity: 0 }}
 animate={{ opacity: 1 }}
 ...
 <p className="text-sm text-primary/80">auditorias ativas</p>
 </div>
 ...
 <p className="text-sm text-primary/80">ações pendentes</p>
 </div>
 <ChevronRight className="h-5 w-5 text-white/60 group-hover:text-white group-hover:translate-x-1 transition-all" />
 </Link>
 </motion.div>
