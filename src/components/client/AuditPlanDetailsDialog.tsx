...
export function AuditPlanDetailsDialog({
 ...
 audit.status ==="in_progress"?"bg-yellow-500 text-white border-0": audit.status ==="planned"?"bg-blue-500 text-white border-0":"bg-gray-500 text-white border-0"}`}
 >
 ...
 field.content 
 ? "bg-card border-border":"bg-muted/30 border-dashed border-muted-foreground/30"
 }`}
 >
