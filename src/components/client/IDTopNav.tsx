...
export function IDTopNav({ currentOrg, actions, counts }: IDTopNavProps) {
 ...
 active
 ? "text-primary ":"text-muted-foreground hover:text-foreground dark:hover:text-white")}
 >
 <item.icon
 ...
 <span
 className={cn("absolute left-3 right-3 -bottom-px h-[3px] rounded-full transition-all",
 active ? "bg-gradient-to-r from-primary to-primary":"bg-transparent"
 )}
 />
 </Link>
 </li>
