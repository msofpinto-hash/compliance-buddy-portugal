...
export function ModuleCard({
  ...
  const getShadowColor = () => {
    ...
    if (gradient.includes("blue"))
      return "hover:shadow-blue-500/30 dark:hover:shadow-blue-400/20";
    if (gradient.includes("amber")) return "hover:shadow-primary/30 ";
    if (gradient.includes("purple"))
      return "hover:shadow-purple-500/30 dark:hover:shadow-purple-400/20";
    if (gradient.includes("rose"))
      return "hover:shadow-rose-500/30 dark:hover:shadow-rose-400/20";
