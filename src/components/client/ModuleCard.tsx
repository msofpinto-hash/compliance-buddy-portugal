...
export function ModuleCard({
 ...
 if (gradient.includes("emerald")) return "hover:shadow-primary/30 ";
 if (gradient.includes("blue")) return "hover:shadow-blue-500/30 dark:hover:shadow-blue-400/20";
 if (gradient.includes("amber")) return "hover:shadow-primary/30 ";
 ...
 "bg-gradient-to-br from-white via-slate-50 to-primary/50",
 "dark:from-slate-700 dark:via-slate-600 ",
 "border border-primary/50 dark:border-slate-500/30",
 ...
 {/* Glow Effect */}
 <div className={cn("absolute -inset-1 rounded-2xl opacity-0 group-hover:opacity-60 blur-xl transition-opacity duration-500 -z-10",
 "bg-gradient-to-r",
 gradient
 )} />
 ...
 <div className={cn("absolute top-0 left-0 right-0 h-1.5 group-hover:h-2 transition-all duration-300",
 "bg-gradient-to-r",
 gradient
 )} />
 <div className={cn(
 ...
 <h3 className="font-bold text-lg text-slate-800 dark:text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-primary group-hover:to-teal-600 dark:group-hover:to-teal-400 transition-all duration-300">
 {title}
 </h3>
 ...
 <motion.div 
 className="absolute bottom-5 right-5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"initial={{ x: -10, opacity: 0 }}
 whileHover={{ x: 0, opacity: 1 }}
 >
 <motion.div 
 className={cn("p-2 rounded-full shadow-lg",
 "bg-gradient-to-r",
 gradient
 )}
 animate={{ x: [0, 4, 0] }}
