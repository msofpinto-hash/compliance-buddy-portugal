...
const GLOW_CONFIGS = {
  ...
  amber: {
    border: "border-primary/60 hover:border-primary/80 ",
    shadow:
      "shadow-[0_4px_20px_hsl(38_80%_50%/0.1)] hover:shadow-[0_8px_30px_hsl(38_80%_50%/0.2)]",
  ...
  terracotta: {
    border:
      "border-orange-200/60 dark:border-orange-800/40 hover:border-orange-400/80 dark:hover:border-orange-700/60",
    shadow:
      "shadow-[0_4px_20px_hsl(15_50%_50%/0.1)] hover:shadow-[0_8px_30px_hsl(15_50%_50%/0.2)]",
    gradient: "from-orange-400 to-red-500",
    text: "text-orange-600 dark:text-orange-400",
    badge:
      "bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-300 border-orange-300/50 dark:border-orange-700/50",
  },
  stone: {
    border: "border-border/60 hover:border-border/80 ",
    shadow:
      "shadow-[0_4px_20px_hsl(30_10%_40%/0.1)] hover:shadow-[0_8px_30px_hsl(30_10%_40%/0.15)]",
  ...
  rose: {
    border:
      "border-rose-200/60 dark:border-rose-800/40 hover:border-rose-400/80 dark:hover:border-rose-700/60",
    shadow:
      "shadow-[0_4px_20px_hsl(350_80%_55%/0.1)] hover:shadow-[0_8px_30px_hsl(350_80%_55%/0.15)]",
    gradient: "from-rose-400 to-pink-500",
    text: "text-rose-600 dark:text-rose-400",
    badge:
      "bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-300 border-rose-300/50 dark:border-rose-700/50",
  },
};
        ...
        >
          ...
          <div className="relative h-full p-5 flex flex-col">
            ...
            >
              <motion.div
                className={cn(
                  "p-2 rounded-lg border backdrop-blur-sm bg-white/80 ",
                  config.border,
                )}
                animate={{ x: [0, 4, 0] }}
                transition={{
