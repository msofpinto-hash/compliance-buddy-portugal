      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground leading-tight font-medium tracking-wider">
              COMPLIANCE
            </span>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-gradient-to-r from-primary/80 to-teal-50/80 dark:to-teal-900/20 text-primary border border-primary/50 "
                ...
                {item.count !== undefined && item.count > 0 && (
                  <Badge
                    className={cn(
                      ...
                      isActive
                        ? "bg-primary/60 text-primary border-primary/50"
