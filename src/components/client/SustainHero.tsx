...
export function SustainHero({
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(100deg,hsl(var(--hero-scrim)/0.96)_0%,hsl(var(--hero-scrim)/0.82)_50%,hsl(var(--hero-scrim)/0.4)_100%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(120%_120%_at_0%_100%,hsl(var(--primary)/0.35)_0%,transparent_55%)]" />
